				...
				<form action="/" method="get" accept-charset="utf-8">
					...
					<div>
						...
						<select name="column-width" id="column-width" size="1">
							...
							<option value="one-third" selected="selected">1/3 Column</option>
							...
							<option value="two-thirds">2/3 Column</option>
							<option value="two-thirds-last">2/3 Column (Last)</option>
						</select>
					</div>
